...
| Chalkiness | `data-chalk="tidy\|normal\|rough"` on `.slate`, from question 4. One attribute sets slip strength, waver probability, `--tilt`, stroke grain (gaps), and long-stroke fade. Never hand-tune the filters per figure |
...
| 4 | Chalk | How chalky? | Tidy: a careful teacher, faint waver, no gaps, no tilt / Normal (default): what the examples use, light dust / Rough: end of a long lecture, strong waver, strokes skip and break, long lines fade toward the end, visible tilt |
